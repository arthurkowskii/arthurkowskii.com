# 🌌 Portfolio Interactif - Visualisation Atomique

**Arthur Kowskii Croquebois** | Étudiant ISART DIGITAL  
*Musique • Sound Design • Développement Technique*

[![GitHub Stars](https://img.shields.io/github/stars/arthurkowskii/arthurkowskii.com?style=flat-square)](https://github.com/arthurkowskii/arthurkowskii.com/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/arthurkowskii/arthurkowskii.com?style=flat-square)](https://github.com/arthurkowskii/arthurkowskii.com/network)
...
## 🤖 Innovation : IA Agentique dans le Développement

Ce projet illustre une approche moderne du développement web intégrant :
- **IA Agentique** pour l'assistance au développement
- **RAG (Retrieval-Augmented Generation)** pour la documentation
- **Automations intelligentes** pour l'optimisation du workflow

Cette méthodologie démontre une adaptation aux outils émergents de l'industrie technologique.
...
├── content/           # Collections de projets
│   └── projects/      # Projets par catégorie
├── pages/             # Pages et routing
└── user-tweaks.js     # Configuration centrale
```
...
- **Questions** sur l'implémentation technique
- **Partage d'idées** pour améliorer l'expérience
- **Discussions** sur l'industrie du jeu vidéo et l'audio

### 📧 Contact Professionnel
*Ouvert aux opportunités dans l'industrie du jeu vidéo*

**Étudiant ISART DIGITAL** - Formation spécialisée jeu vidéo  
**Profil multidisciplinaire** : Technique + Créatif
...
*Portfolio conçu pour les professionnels de l'industrie du jeu vidéo cherchant des talents polyvalents en audio et développement technique.*